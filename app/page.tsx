...
export default function Home(){
  ...
  return <main>
    <nav className="nav"><a className="brand" href="#top"><span className="brand-mark">七</span><span>DOWN TOWN RAMEN</span></a><Link className="chef-link" href="/admin">ניהול</Link></nav>
    <section className="hero" id="top"><div className="eyebrow"><span/> המועדים הקרובים</div><h1>מקום ליד<br/>בר הראמן.</h1><p className="lede">ראמן בעבודת יד, מוגש מעבר לדלפק. בחרו שעה ואנחנו נשמור לכם מקום.</p></section>
    ...
    <footer><span>ראמן · מוזיקה · חברה טובה</span><span>מוכן בכמויות קטנות</span></footer>
