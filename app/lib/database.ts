...
export function ensureSchema() {
  schemaReady ??= (async () => {
    ...
    await db.batch([
      ...
      db.prepare(`CREATE TABLE IF NOT EXISTS service_days (day_key TEXT PRIMARY KEY, actual_attendees INTEGER NOT NULL CHECK (actual_attendees >= 0), completed_at TEXT NOT NULL, completed_by TEXT NOT NULL)`),
